...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(600, 71);
			...
			// button_rules
			// 
			this->button_rules->Location = System::Drawing::Point(600, 212);
			this->button_rules->Name = L"button_rules";
			this->button_rules->Size = System::Drawing::Size(171, 53);
